        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="pb-12 lg:pb-24">
            ...
            <h1 className="mt-5 text-4xl font-bold leading-[1.1] tracking-[-0.03em] text-[#142F86] sm:text-5xl lg:text-[3.25rem]">
              Diagnostic
              <span className="block text-[#31B4F4]">Partnerships</span>
            </h1>
            <p className="mt-5 max-w-lg text-lg leading-relaxed text-[#142F86]/70">
              Establish a long-term partnership for reliable, preferential-rate
              diagnostic services — backed by radiologist-led precision and a
          ...
          <div className="relative hidden lg:flex lg:items-end lg:justify-center">
            <div className="relative h-[500px] w-[440px]">
              <div className="absolute inset-0 overflow-hidden rounded-[2.5rem] shadow-2xl">
                ...
                <img
                  src="https://images.unsplash.com/photo-1579154204601-01588f351e67?w=880&q=85"
                  alt="Lab technician handling diagnostic samples in a modern laboratory"
              ...
              <div className="absolute -left-8 bottom-16 rounded-2xl bg-white p-4 shadow-xl">
                <div className="flex items-center gap-3">
                  <span className="grid size-10 shrink-0 place-items-center rounded-full bg-[#31B4F4]/15">
                    <ShieldCheck className="size-5 text-[#31B4F4]" />
                  </span>
                  <div>
      ...
      <section className="bg-[#F7FAFF] py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#142F86] sm:text-4xl">
            Built for Long-Term
            <span className="block">Healthcare Partnerships</span>
          </h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {BENEFITS.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="flex flex-col gap-4 rounded-2xl border border-[#142F86]/8 bg-white p-6 shadow-sm"
              >
                <span className="grid size-11 place-items-center rounded-2xl bg-[#31B4F4]/12">
                  <Icon className="size-5 text-[#31B4F4]" />
                </span>
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl items-start gap-16 px-5 sm:px-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-[#142F86] sm:text-3xl">
              Trusted by Organisations
              <span className="block">Across Healthcare</span>
            </h2>
            ...
            <div className="mt-10 overflow-hidden rounded-2xl shadow-lg">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://images.unsplash.com/photo-1631815588090-d1bcbe9a8561?w=800&q=80"
                alt="Healthcare professionals in a meeting discussing diagnostic partnership"
          ...
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-[#142F86] sm:text-3xl">
              From Enquiry to
              <span className="block">First Referral in Days</span>
            </h2>
            <ol className="mt-7 space-y-6">
              {HOW.map(({ step, title, desc }) => (
                <li key={step} className="flex gap-5">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#142F86] text-sm font-black text-white">
                    {step}
                  </span>
                  <div>
                    <h3 className="font-bold text-[#142F86]">{title}</h3>
                    <p className="mt-1 text-sm leading-relaxed text-[#142F86]/65">{desc}</p>
                  </div>
                </li>
              ))}
            </ol>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-white/70">
              Fill in the form and our corporate team will reach out within one
              business day with a custom proposal.
            </p>
          </div>
