...
.cm-root{--green:#142F86;--green-deep:#DA1C29;--lime:#31B4F4;--lime-b:rgb(49 180 244 / .82);--mint:#FFFFFF;--mint-deep:#FFFFFF;--ink:#142F86;--muted:rgb(20 47 134 / .55);--subtle:rgb(20 47 134 / .72);--line:rgb(20 47 134 / .16);--glass:#FFFFFF;--glass-s:#FFFFFF;--glass-strong:#FFFFFF;
  position:relative;isolation:isolate;background:#FFFFFF;color:var(--ink);font-family:var(--font-inter),system-ui,-apple-system,sans-serif;font-weight:400;line-height:1.2;-webkit-font-smoothing:antialiased;overflow-x:clip}
...
@media(max-width:767px){
  ...
  .cm-why__badge{position:absolute;bottom:6%;left:-14%;display:grid;place-content:center;width:6.1rem;height:6.1rem;border-radius:50%;background:#FFFFFF;box-shadow:0 10px 26px -14px rgb(20 47 134 / .45);font-family:var(--font-inter),system-ui,-apple-system,sans-serif;font-style:italic;font-size:.8rem;line-height:1.35;text-align:center;color:var(--green)}
...
.cm-why-mag__title,.cm-why-mag__list li{font-family:var(--font-inter),system-ui,-apple-system,sans-serif;font-size:1.375rem;line-height:1.3;letter-spacing:-.01em;color:#FFFFFF;text-shadow:0 1px 12px rgb(8 16 38 / .58)}
...
.cm-svc__line{margin:1.1rem 0 0;max-width:34rem;font-family:var(--font-inter),system-ui,-apple-system,sans-serif;font-size:.9rem;font-weight:500;line-height:1.5;color:#FFFFFF;text-shadow:0 2px 14px rgb(0 0 0 / .5)}
