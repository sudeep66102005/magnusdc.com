...
export const healthPackages: HealthPackageContent[] = [
  // === ROUTINE HEALTH PACKAGES (Cumulative) ===
  packageItem("basic-health-profile", "Basic Health Profile", "checkup", 1650, 3260, "A practical baseline health assessment with physician consultation.", [
  ...
  packageItem("full-body-blood-test", "Full Body Blood Test Package 1", "checkup", 2500, 4650, "Everything in Basic Health Profile PLUS: Extended blood work covering metabolic health, organ function and key vitamins.", [
  ...
  packageItem("comprehensive-health-check", "Comprehensive Health Check Package 2", "checkup", 3850, 5940, "Everything in Package 1 PLUS: Imaging and cardiac screening for a broad preventive review.", [
    "Complete Blood Count with ESR",
    "Fasting Blood Sugar",
  ...
  packageItem("master-health-checkup", "Essential / Master Health Checkup Package 3", "checkup", 5100, 9380, "Everything in Package 2 PLUS: Advanced cardiac evaluation with TMT/ECHO and comprehensive imaging.", [
    "Complete Blood Count with ESR",
    "Fasting Blood Sugar",
    "Post Prandial Blood Sugar",
    "Blood Urea",
  ...
  packageItem("womens-wellness-package", "Women Wellness Package", "womens-health", 5790, 9630, "Comprehensive preventive screening designed around women’s health needs.", ["Complete Blood Count", "Fasting Blood Sugar", "Post Prandial Blood Sugar", "Blood Urea", "Creatinine", "Lipid Profile", "SGOT", "SGPT", "Calcium", "Vitamin D3", "Thyroid Profile", "Complete Urine Analysis", "Chest X-ray", "ECG", "Ultrasound Abdomen & Pelvis", "Bilateral Sonomammography", "PAP Smear", "Consultation"]),
